    ...
    public class BookDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Book>()
                .HasOne(x => x.Rating)
                .WithOne()
                .HasForeignKey<Rating>(x => x.BookId);
        ...
        private void Seed()
        {
            Books.AddRange(
                    new Book()
                    {
                        ...
                        Cover = "Мистецтво розроболення програмного заберпечення",
                    ...
                    new Book()
                    {
                        ...
                        Author = "Роберт Мартін",
                        Title = "Чистий код",
                        Cover = "Створення і рефакторинг за допомого AGILE",
                    ...
                    new Book()
                    {
                        ...
                        Cover = "Як ІТ-гіганти та їхні розумні машини можуть змінити людство",
                    ...
                    new Book()
                    {
                        ...
                        Cover = "Війна, саботаж і страх у кіберепоху",
                    ...
                    new Book()
                    {
                        ...
                        Cover = "Що трапилося з нашим світом? Чому пожежники спалюють будинки, а не гасять пожежі?" +
                        " Чому люди не читають книги, не ходять пішки і майже не розмовляють одне з одним? " +
                        "Як виглядатиме наша Земля та якими будуть люди, якщо заборонити їм читати книги? Зі " +
                        "сторінок одного з найкращих творів Рея Бредбері ви дізнаєтеся, як люди навчаться зберігати " +
                        "книги для наступних поколінь, хто повстане проти пануючої системи і як зустріч із “чудною” " +
                        "дівчиною Кларіс змінить життя пожежника Ґая Монтеґа…",
                    ...
                    new Book()
                    {
                        ...
                        Cover = "У чому полягає робота ангела? Чи можна вплинути на людський вибір?" +
                        " Чи можна зробити людину щасливою? Чи є межа на шляху пізнання?",
